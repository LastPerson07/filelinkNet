...
SESSION = environ.get('SESSION', '')  # Pyrogram client session name
...
BOT_USERNAME = environ.get("BOT_USERNAME", '')  # Bot's username
...
DB_URL = environ.get('DATABASE_URI', "0")  # MongoDB connection URI
...
# 🌐 Server Settings
PORT = int(getenv('PORT', ''))  # Port for web server
